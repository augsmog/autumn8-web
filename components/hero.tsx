      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center px-4 py-2 bg-orange-100 rounded-full text-orange-700 text-sm mb-6">
            ...
            Instant and Intelligent Automation for Everyone
          </div>
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Save 20+ hours per week with intelligent automation. We handle your scheduling,
            invoicing, follow-ups, and data entry so you can focus on what matters most.
          </p>
